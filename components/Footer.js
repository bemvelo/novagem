    ...
    <footer style={{ background: "linear-gradient(135deg, #4e2d96 0%, #6c3fc5 100%)", color: "#fff", fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", marginTop: "auto" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "48px 32px 32px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "40px", marginBottom: "40px" }}>
          ...
          {/* Brand */}
          <div>
            <span style={{ fontFamily: "Georgia, serif", fontSize: "24px", fontWeight: "700", letterSpacing: "4px", color: "#fff", display: "block", marginBottom: "16px" }}>novagem</span>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              {[["📷", "Instagram", "https://www.instagram.com/novagem__jewellery/"], ["💬", "WhatsApp", "https://wa.me/263787527809"]].map(([icon, label, url]) => (
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
              {[["📍", "Bulawayo, Zimbabwe"], ["📧", "info@novagem.com"], ["📞", "+263 787527809"], ["🕐", "Mon-Sat 9am-6pm"]].map(([icon, text]) => (
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.15)", paddingTop: "24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
          <p style={{ fontSize: "12px", color: "#c4a8f0" }}>© {new Date().getFullYear()} novagem. All rights reserved.</p>
